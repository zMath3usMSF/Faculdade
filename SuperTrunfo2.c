...
int main(){
    ...
    */
    ...
    cidadedensidadepopulacional1 = cidadepopulacao1 / cidadearea1; //Calcula a Densidade Populacional da Cidade da Carta 1;
    ...
    */
    ...
    cidadedensidadepopulacional2 = cidadepopulacao2 / cidadearea2; //Calcula a Densidade Populacional da Cidade da Carta 2;
